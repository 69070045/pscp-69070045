...
```
input ก็รับtextที่เป็นตัวอักษรเข้ามาแล้วใช้อslicing -1 เพื่อที่ให้เขียนกลับหลังและใช้ .lower เพื่อให้outputเป็นตัวพิมพ์เล็ก 
...
```text
Step 1: เขียนรับค่า input 
Step 2: หาวิธีทำให้ข้อความเขียนมาจากด้านหลัง
Step 3: ทำให้ตัวอักษรเป็นตัวเล็ก
```
...
```text
การใช้slicingเพื่อให้เขียนกลับหลังและ.lowerเพื่อให้เป็นตัวเล็ก
```
...
```text
ช่วยสอนว่า slicing เขียนยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนทุกอย่งด้วยตัวเองติดแค่ตรงslicingว่าเขียนยังไง
```
