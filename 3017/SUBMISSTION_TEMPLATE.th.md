...
```
รับinputมาแล้วมาหาวิธีคำนวนค่าที่ได้มา ส่วนoutputคือการนำค่าที่ผ่านการคำนวนแล้วมาตอบ
...
Step 2: เขียนคำนวนinputที่เราได้รับมา
Step 3: เช็คเงื่อนไขของค่าบริการ
```
...
```text
เหมือนกันเพราะคิดถูกตั้งแต่แรกแล้ว
---
...
```text
ถ้าใส่เลขน้อยๆแล้วค่าบริการจะเป็น50รึป่าว
```
...
```text
บอกตรง if else ว่าพลาดตรงไหน พลาดแค่ == แทนที่ต้องเป็น = 
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนทุกอย่งด้วยตัวเองติดแค่ตรง =
```
