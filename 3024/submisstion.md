...
```
โจทย์ให้inputมาสองค่าคือคะแนนรวมและคะแนนสูงสุด เราก็นำมาคำนวนและหาว่าถ้าค่าของแต่ละคนห่างกันเกิน2คือsurprising
...
```text
Step 1: เขียนสมการคิดค่าคะแนนต่ำสุด
Step 2: เขียนifว่าถ้าคะแนนต่ำสุดคือ0
Step 3: เขียนif elseเทียบค่าที่ได้มา
```
...
```text
เหมือนกัน เพราะคิดมาถูกทางแล้ว
```
...
```text
ไกด์การเขียนหาค่าต่ำสุด
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนและแก้testcaseด้วยตนเอง
```
