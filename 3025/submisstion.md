...
```
inputที่เข้ามาคือเดือนกับวัน หลักๆจะใช้เดือนเพื่อแบ่งฤดู ใช้วันเพื่อให้เป็นไปตามเงื่อนไข ละก็นำมาทำ if elif เพื่อแบ่งฤดูให้ถูกเงื่อนไข
...
Step 2: ใช้if elifเพื่อแบ่งฤดู
Step 3: ใช้input dayที่ให้มาเพื่อทำตามเงื่อนไข
```
...
```text
ถ้าเดือนที่3เป็นวันที่31จะเกิดอะไรขึ้น
```
