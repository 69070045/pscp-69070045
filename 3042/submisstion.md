...
```
รับinputเข้ามาแล้วทำให้inputสามารถหารได้ด้วย10แล้วลงตัว แล้วเขียนoutputให้อยู๋ในบรรทัดเดียวกัน
...
```text
Step 1: เขียนรับค่า input และสร้างlist
Step 2: ทำให้inputหารด้วย10ลงตัวคือ นำเศษเหลือที่หารด้วย10มาลบกับinput
Step 3: ใช้loopเพื่อให้ค่าลดลงทีละ10
```
