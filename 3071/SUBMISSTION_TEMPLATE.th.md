...
```
นำค่าที่ได้มาใส่ลงไปใน for loop เพื่อที่จะหาเศษที่เหมือนกับinputว่ามีกี่ตัว
...
```text
Step 1: เขียนรับค่า input A B r d
Step 2: เขียน for loop แล้วนำ A B ไปใส่
Step 3: เขียนif เพื่อหาว่ามีเศษที่ตรงกับ r กี่ตัว
```
...
```text
เหมือนกัน เพราะมีเพื่อนไกด์ช่วยตอนเริ่ม
```
