...
```
รับค่า input.split มาแล้วใช้ if elif เพื่อคำนวนค่าธรรมเนียม
...
```text
Step 1: เขียนรับค่า input.split()
Step 2: เขียน if elif เพื่อหาว่าต้นทางปลายทางและน้ำหนักคืออะไรและมีค่าธรรมเนียมเท่าไหร่
Step 3: ใช้ :.2f เพื่อให้ output ออกมาเป็นทศนิยม2ตำแหน่ง
```
...
```text
เหมือนกัน เพราะ รู้ว่าต้องเริ่มจากตรงไหนยังไง
```
...
```text
ถ้าใส่ปลายทางผิดจะเกิดอะไรขึ้น
```
