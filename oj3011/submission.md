...
```text
รับinputสีเข้ามา2ค่าแล้วทำif else เพื่อจัดระบบให้เป็นไปตามoutputที่เราต้องการ โดยเอาสีแต่ละสีมาผสมกัน
```
...
```text
Step 1:รับinputมา2ค่า
Step 2:ใช้ if else เพื่อรับค่าสีมาคิด
Step 3:จะใช้ if ซ้อน if 
```
...
```text
รับค่าสีมา2ค่าแล้วใช้ if else มาตรวจสอบสีว่าจะผสมเป็นสีอะไร(ex สีแดง และ สีฟ้า รวมเป็น สีม่วง)จากนั้นก็printค่ามันออกมา
```
...
```text
ลองดูว่าจะเป็นไปตามโค้ดที่เขียนมั้ย
```
...
```text
ยังเขียนและแก้errorด้วยตัวเองทั้งหมด
```
