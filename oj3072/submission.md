...
```text
รับค่า input มาเป็น.lower() และนำมาเขียน if elif เพื่อหาค่าที่ต้องการ
```
...
```text
Step 1: เขียนรับค่า input.lower()
Step 2: เขียน if elif เพื่อหาว่า aeiou ว่ามีกี่ตัว
Step 3: ใช้.count เพื่อนับจำนวน
```
...
```text
เหมือนกัน เพราะ รู้สชว่าต้องเริ่มจากตรงไหนยังไง
```
...
```text
ถ้าเป็นตัวพิมพ์ใหญ่จะเป็นยังไง
```
