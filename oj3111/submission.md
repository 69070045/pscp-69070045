...
```text
รับ input มาว่าเป็นสมาชิกหรือไม่และรับจำนวนที่จะซื้อจากนั้นนำมาหา output คือนำค่าที่ได้มาคำนวนหาส่วนลด
```
...
```text
Step 1: รับinputว่าจะให้มีกี่ค่า
Step 2: สร้าง list
Step 3: ตรวจสอบกรณีที่เป็นสมาชิก
Step 4: ตรวจสอบกรณีที่ไม่เป็นเป็นสมาชิก
...
```text
เหมือนกับแผนแรกเลยเพราะตรวจหากรณีกรณีที่แตกต่างกันเพื่อหาส่วนลด
```
...
```text
ถ้ามีทศนิยมหลายตำแหน่งจะerrorมั้ย
```
...
```text
ถ้าใส่ผิดเป็นติดลบจะเกิดอะไรขึ้น
```
...
```text
ช่วยไกด์ตรงกรณืที่มันจะคลาดเคล่ือน
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนและตีโจทย์ด้วยตัวเอง
```
