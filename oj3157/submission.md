...
```text
รับinputมาแล้ว for loopเพื่อรับinputต่อจากนั้นก็ตรวจค่าเพื่อหาคำตอบ
```
...
```text
เขียน for loop เพิ่อรับค่า แล้วนำค่าที่ได้มาคำนวน + - เพื้อหาคำตอบออกมา
```
...
```text
ถ้าเขียน + และ - เท่ากันจะเกิดอะไรขึ้น
```
...
```text
ถ้ามี - อย่างเดียวจะเกิดอะไรขึ้น
```
