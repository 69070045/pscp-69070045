...
```text
รับค่า input มา2ค่าคือ ค่าเริ่มต้นและค่าสิ้นสุด จากนั้นหาจำนวนเฉพาะระหว่าง2ค่า
```
...
```text
รับค่ามา2ตัวจากนั้นloopเพื่อหาจำนวนเฉพาะ
```
...
```text
รับมา2เลขแล้วก็มีตัวแปรกับlistเพื่อเก็บค่าจำนวนเฉพาะ จากนั้นก็loopหา
```
...
```text
ถ้าใส่เลขเท่ากันจะเกิดอะไรขึ้น
```
...
```text
ถ้าใส่เลขหลังน้อยกว่าเลขแรกจะเกิดอะไรขึ้น
```
...
```text
ช่วยสอนตรง loop ว่าต้องเขียนยังไงอะไรบ้าง
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนทุกอย่างด้วยตัวเอง
```
